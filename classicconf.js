...
global.gr = 'https://chat.whatsapp.com/IUMMsqq1lpn6jmthoMCnm5'
global.ig = 'ano_nymous_sam' // ubah aja
global.email = 'samuelcircute@gmail.com' //serah
global.region = 'kenya' // serah
//—————「 Set Nama Own & Bot 」—————//
global.ownername = 'ꪶ༺֎ᚏ༈࿉𝙱𝙴𝙻𝙸𝙴𝚅𝙴™️⧉ᚙ֎⸙༻' //ubah jadi nama mu, note tanda ' gausah di hapus!
//=================================================//
...
global.author = '༻࿇𝙱𝙴𝙻𝙸𝙴𝚅𝙴™️❖༺' // ubah aja ini nama sticker
global.prefa = ['!','.',',','🐤','🗿']
